...
set(__qt_Concurrent_target_deps "Qt6Core\;6.1.3")
foreach(__qt_Concurrent_target_dep ${__qt_Concurrent_target_deps})
    list(GET __qt_Concurrent_target_dep 0 __qt_Concurrent_pkg)
    list(GET __qt_Concurrent_target_dep 1 __qt_Concurrent_version)

    if (NOT ${__qt_Concurrent_pkg}_FOUND)
        find_dependency(${__qt_Concurrent_pkg} ${__qt_Concurrent_version}
            PATHS
                "${CMAKE_CURRENT_LIST_DIR}/.."
                ${_qt_additional_packages_prefix_path}
                ${_qt_additional_packages_prefix_path_env}
