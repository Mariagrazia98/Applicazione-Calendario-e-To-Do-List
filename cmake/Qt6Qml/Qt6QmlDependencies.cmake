...
set(__qt_Qml_tool_deps "Qt6QmlTools\;6.1.3")
...
set(__qt_Qml_target_deps "Qt6Core\;6.1.3;Qt6Network\;6.1.3")
foreach(__qt_Qml_target_dep ${__qt_Qml_target_deps})
    list(GET __qt_Qml_target_dep 0 __qt_Qml_pkg)
    list(GET __qt_Qml_target_dep 1 __qt_Qml_version)

    if (NOT ${__qt_Qml_pkg}_FOUND)
        find_dependency(${__qt_Qml_pkg} ${__qt_Qml_version}
            PATHS
                "${CMAKE_CURRENT_LIST_DIR}/.."
                ${_qt_additional_packages_prefix_path}
                ${_qt_additional_packages_prefix_path_env}
