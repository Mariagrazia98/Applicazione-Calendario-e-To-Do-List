...
set(__qt_BundledLibpng_target_deps "Qt6Core\;6.1.3")
foreach(__qt_BundledLibpng_target_dep ${__qt_BundledLibpng_target_deps})
    list(GET __qt_BundledLibpng_target_dep 0 __qt_BundledLibpng_pkg)
    list(GET __qt_BundledLibpng_target_dep 1 __qt_BundledLibpng_version)

    if (NOT ${__qt_BundledLibpng_pkg}_FOUND)
        find_dependency(${__qt_BundledLibpng_pkg} ${__qt_BundledLibpng_version}
            PATHS
                "${CMAKE_CURRENT_LIST_DIR}/.."
                ${_qt_additional_packages_prefix_path}
                ${_qt_additional_packages_prefix_path_env}
