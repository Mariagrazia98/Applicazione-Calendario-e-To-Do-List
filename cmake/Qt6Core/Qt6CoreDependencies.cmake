...
set(__qt_Core_tool_deps "Qt6CoreTools\;6.1.3")
...
set(__qt_Core_target_deps "Qt6EntryPoint\;6.1.3")
foreach(__qt_Core_target_dep ${__qt_Core_target_deps})
    list(GET __qt_Core_target_dep 0 __qt_Core_pkg)
    list(GET __qt_Core_target_dep 1 __qt_Core_version)

    if (NOT ${__qt_Core_pkg}_FOUND)
        find_dependency(${__qt_Core_pkg} ${__qt_Core_version}
            PATHS
                "${CMAKE_CURRENT_LIST_DIR}/.."
                ${_qt_additional_packages_prefix_path}
                ${_qt_additional_packages_prefix_path_env}
...
set(_Qt6Core_MODULE_DEPENDENCIES "EntryPoint")
