...
set(__qt_OpenGLWidgets_target_deps "Qt6OpenGL\;6.1.3;Qt6Widgets\;6.1.3")
foreach(__qt_OpenGLWidgets_target_dep ${__qt_OpenGLWidgets_target_deps})
    list(GET __qt_OpenGLWidgets_target_dep 0 __qt_OpenGLWidgets_pkg)
    list(GET __qt_OpenGLWidgets_target_dep 1 __qt_OpenGLWidgets_version)

    if (NOT ${__qt_OpenGLWidgets_pkg}_FOUND)
        find_dependency(${__qt_OpenGLWidgets_pkg} ${__qt_OpenGLWidgets_version}
            PATHS
                "${CMAKE_CURRENT_LIST_DIR}/.."
                ${_qt_additional_packages_prefix_path}
                ${_qt_additional_packages_prefix_path_env}
