...
set(__qt_Widgets_tool_deps "Qt6WidgetsTools\;6.1.3")
...
set(__qt_Widgets_target_deps "Qt6Core\;6.1.3;Qt6Gui\;6.1.3")
foreach(__qt_Widgets_target_dep ${__qt_Widgets_target_deps})
    list(GET __qt_Widgets_target_dep 0 __qt_Widgets_pkg)
    list(GET __qt_Widgets_target_dep 1 __qt_Widgets_version)

    if (NOT ${__qt_Widgets_pkg}_FOUND)
        find_dependency(${__qt_Widgets_pkg} ${__qt_Widgets_version}
            PATHS
                "${CMAKE_CURRENT_LIST_DIR}/.."
                ${_qt_additional_packages_prefix_path}
                ${_qt_additional_packages_prefix_path_env}
