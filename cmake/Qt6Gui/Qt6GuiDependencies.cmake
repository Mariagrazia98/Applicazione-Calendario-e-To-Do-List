...
set(__qt_Gui_third_party_deps "Vulkan\;TRUE\;\;\;")
...
set(__qt_Gui_tool_deps "Qt6GuiTools\;6.1.3")
...
set(__qt_Gui_target_deps "Qt6Core\;6.1.3")
foreach(__qt_Gui_target_dep ${__qt_Gui_target_deps})
    list(GET __qt_Gui_target_dep 0 __qt_Gui_pkg)
    list(GET __qt_Gui_target_dep 1 __qt_Gui_version)

    if (NOT ${__qt_Gui_pkg}_FOUND)
        find_dependency(${__qt_Gui_pkg} ${__qt_Gui_version}
            PATHS
                "${CMAKE_CURRENT_LIST_DIR}/.."
                ${_qt_additional_packages_prefix_path}
                ${_qt_additional_packages_prefix_path_env}
