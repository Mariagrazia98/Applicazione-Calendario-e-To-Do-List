...
set(__qt_QuickTest_target_deps "Qt6Core\;6.1.3;Qt6Test\;6.1.3")
foreach(__qt_QuickTest_target_dep ${__qt_QuickTest_target_deps})
    list(GET __qt_QuickTest_target_dep 0 __qt_QuickTest_pkg)
    list(GET __qt_QuickTest_target_dep 1 __qt_QuickTest_version)

    if (NOT ${__qt_QuickTest_pkg}_FOUND)
        find_dependency(${__qt_QuickTest_pkg} ${__qt_QuickTest_version}
            PATHS
                "${CMAKE_CURRENT_LIST_DIR}/.."
                ${_qt_additional_packages_prefix_path}
                ${_qt_additional_packages_prefix_path_env}
