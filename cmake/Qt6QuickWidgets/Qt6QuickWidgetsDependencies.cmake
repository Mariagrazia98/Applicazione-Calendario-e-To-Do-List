...
set(__qt_QuickWidgets_target_deps "Qt6Core\;6.1.3;Qt6Gui\;6.1.3;Qt6Qml\;6.1.3;Qt6Quick\;6.1.3;Qt6Widgets\;6.1.3")
foreach(__qt_QuickWidgets_target_dep ${__qt_QuickWidgets_target_deps})
    list(GET __qt_QuickWidgets_target_dep 0 __qt_QuickWidgets_pkg)
    list(GET __qt_QuickWidgets_target_dep 1 __qt_QuickWidgets_version)

    if (NOT ${__qt_QuickWidgets_pkg}_FOUND)
        find_dependency(${__qt_QuickWidgets_pkg} ${__qt_QuickWidgets_version}
            PATHS
                "${CMAKE_CURRENT_LIST_DIR}/.."
                ${_qt_additional_packages_prefix_path}
                ${_qt_additional_packages_prefix_path_env}
