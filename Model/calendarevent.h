...
/**
 *
 * @details CalendarEvent is one of the possible types of CalendarObjects. A VEVENT in 'iCalendar'
 * describes an event, which has a scheduled amount of time on a calendar. Compared to CalendarTodos,
 * CalendarEvents are characterized by a DateTime value which represents the moment in which and event ends.
 */
